...
import (
	...
	samplecontroller "k8s-addingress-with-crd/pkg/apis/samplecontroller/v1alpha1"
	"k8s-addingress-with-crd/pkg/generated/clientset/versioned/fake"
	informers "k8s-addingress-with-crd/pkg/generated/informers/externalversions"
)
...
type fixture struct {
	...
	fooLister        []*samplecontroller.App
...
func newFoo(name string, replicas *int32) *samplecontroller.App {
...
func (f *fixture) expectUpdateFooStatusAction(foo *samplecontroller.App) {
...
func getKey(foo *samplecontroller.App, t *testing.T) string {
